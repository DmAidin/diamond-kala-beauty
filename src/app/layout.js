...
export const metadata = {
  ...
  description:
    "دایمند کالا، فروشگاه اینترنتی خرید آنلاین لوازم آرایشی و بهداشتی اورجینال، با ارسال سریع، بسته‌بندی ویژه و پرداخت امن از طریق درگاه بانکی.",
  keywords: ["لوازم آرایشی", "لوازم بهداشتی", "خرید آنلاین آرایشی", "دایمند کالا", "فروشگاه آرایشی بهداشتی"],
  openGraph: {
    title: "دایمند کالا | فروشگاه آنلاین لوازم آرایشی و بهداشتی",
